...
//////////////////////////////////////////////
const char SSID_ESP[] = "White Devil";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "@King#1589#B2K.REBEL";             //Add the password of that WIFI connection
const char* host = "miniprojectb1.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
